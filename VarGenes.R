# Author: Karthik Shekhar 
#======================================
# This function represents a new method for selection of variable genes. 
# Briefly, a null matematical model is built to model the relationship between average UMI counts 
# and coefficient of variation (CV) across all genes, based on a negative binomial distribution that incorporates 
# sampling noise and relative library size. Those genes that have a CV greater than the null model are chosen as variable. 
