Adult5 <- SubsetData(AdultDorsal, ident.use = 5)
Larva5 <- SubsetData(Larva10x, ident.use = 5)
...
Merge5 = MergeObjects(Larva5, Adult5, id1_use = "res.0.5",id2_use = "res.0.5", 
                      new_id_name = "res", object1_name = "Larva", object2_name = "Adult")
